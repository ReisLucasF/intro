!(function (t, e) {
    ...
    function t() {
        ...
        function w(t) {
            ["próximo", "throw", "voltar"].forEach(function (e) {
                c(t, e, function (t) {
        ...
        function k(t, e, n) {
            ...
            return function (o, i) {
                ...
                for (n.method = o, n.arg = i; ; ) {
                    ...
                    if ("próximo" === n.method) n.sent = n._sent = n.arg;
                    else if ("throw" === n.method) {
                        if ("suspendedStart" === r) throw ((r = "completed"), n.arg);
                        n.dispatchException(n.arg);
                    } else "voltar" === n.method && n.abrupt("voltar", n.arg);
                    r = "executing";
                    var l = p(t, e, n);
                    if ("normal" === l.type) {
        ...
        function x(t, e) {
            ...
            if (void 0 === r)
                return (
                    (e.delegate = null),
                    ("throw" === n && t.iterator.return && ((e.method = "voltar"), (e.arg = void 0), x(t, e), "throw" === e.method)) ||
                        ("voltar" !== n && ((e.method = "throw"), (e.arg = new TypeError("The iterator does not provide a '" + n + "' method")))),
                    h
                );
            ...
            return i
                ? i.done
                    ? ((e[t.resultName] = i.value), (e.next = t.nextLoc), "voltar" !== e.method && ((e.method = "próximo"), (e.arg = void 0)), (e.delegate = null), h)
                    : i
        ...
        return (
            ...
            (j.prototype = {
                constructor: j,
                reset: function (t) {
                    if (((this.prev = 0), (this.next = 0), (this.sent = this._sent = void 0), (this.done = !1), (this.delegate = null), (this.method = "próximo"), (this.arg = void 0), this.tryEntries.forEach(S), !t))
                ...
                dispatchException: function (t) {
                    ...
                    var e = this;
                    function n(n, r) {
                        return (a.type = "throw"), (a.arg = t), (e.next = n), r && ((e.method = "próximo"), (e.arg = void 0)), !!r;
                    }
                    for (var o = this.tryEntries.length - 1; o >= 0; --o) {
                        var i = this.tryEntries[o],
                            a = i.completion;
                        if ("root" === i.tryLoc) return n("fim");
                ...
                abrupt: function (t, e) {
                    ...
                    i && ("break" === t || "continuar" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null);
                    var a = i ? i.completion : {};
                    return (a.type = t), (a.arg = e), i ? ((this.method = "próximo"), (this.next = i.finallyLoc), h) : this.complete(a);
                },
                complete: function (t, e) {
                    if ("throw" === t.type) throw t.arg;
                    return (
                        "break" === t.type || "continuar" === t.type ? (this.next = t.arg) : "voltar" === t.type ? ((this.rval = this.arg = t.arg), (this.method = "voltar"), (this.next = "fim")) : "normal" === t.type && e && (this.next = e),
                        h
                    );
                },
                finish: function (t) {
                ...
                delegateYield: function (t, e, n) {
                    return (this.delegate = { iterator: A(t), resultName: e, nextLoc: n }), "próximo" === this.method && (this.arg = void 0), h;
                },
            }),
            e
        );
    ...
    function j(t, e, n, r, o) {
        ...
        if (
            "off" !== e &&
            t &&
            ((i = "tooltip" === e ? o.getBoundingClientRect() : r.getBoundingClientRect()),
            !(function (t) {
    ...
    function I(t, e, n) {
        if (n && e) {
            ...
            e.element instanceof Element && E(e.element) ? _(n, "introjs-fixedTooltip") : L(n, "introjs-fixedTooltip"),
                ...
                T(n, { width: "".concat(r.width + o, "px"), height: "".concat(r.height + o, "px"), top: "".concat(r.top - o / 2, "px"), left: "".concat(r.left - o / 2, "px") });
        }
    }
    ...
    function B(t, e, n, r) {
        ...
        if (
            ...
            var u,
                p = [];
            "top" === c ? ((u = "top-middle-aligned"), (p = ["top-left-aligned", "top-middle-aligned", "top-right-aligned"])) : ((u = "bottom-middle-aligned"), (p = ["bottom-left-aligned", "bottom-middle-aligned", "bottom-right-aligned"])),
                (c =
                    (function (t, e, n, r) {
                        var o = e / 2,
                            i = Math.min(n, window.screen.width);
                        return (
                            i - t < e && (q(r, "top-left-aligned"), q(r, "bottom-left-aligned")),
                            (t < o || i - t < o) && (q(r, "top-middle-aligned"), q(r, "bottom-middle-aligned")),
                            t < e && (q(r, "top-right-aligned"), q(r, "bottom-right-aligned")),
                            r.length ? r[0] : null
                        );
            ...
            switch (l) {
                ...
                case "right":
                    (n.style.left = "".concat(a.width + 20, "px")),
                        a.top + i.height > s.height ? ((r.className = "introjs-arrow left-bottom"), (n.style.top = "-".concat(i.height - a.height - 20, "px"))) : (r.className = "introjs-arrow left");
                    break;
                case "left":
                    o || !0 !== t._options.showStepNumbers || (n.style.top = "15px"),
                        a.top + i.height > s.height ? ((n.style.top = "-".concat(i.height - a.height - 20, "px")), (r.className = "introjs-arrow right-bottom")) : (r.className = "introjs-arrow right"),
    ...
    function G(t, e) {
        ...
        null === n && ((n = M("div", { className: "introjs-disableInteraction" })), t._targetElement.appendChild(n)), I(t, e, n);
    }
    function V(t, e) {
    ...
    function W(t) {
        ...
        return (
            n.setAttribute("role", "progress"), n.setAttribute("aria-valuemin", "0"), n.setAttribute("aria-valuemax", "100"), n.setAttribute("aria-valuenow", r.toString()), (n.style.cssText = "width:".concat(r, "%;")), e.appendChild(n), e
        );
    }
    function Y(t, e, n) {
                                ...
                                if (
                                    ...
                                    null !== i && null !== a
                                        ...
                                        : ((v = M("div", { className: s })),
                                          ...
                                          (N = M("div")),
                                          T(v, { "box-shadow": "0 0 1px 2px rgba(33, 33, 33, 0.8), rgba(33, 33, 33, ".concat(n._options.overlayOpacity.toString(), ") 0 0 0 5000px") }),
                                          C(n._options.scrollToElement, o.element),
                                          I(n, o, v),
                                          I(n, o, b),
                                          ...
                                          n._options.dontShowAgain &&
                                              ...
                                              ((P = M("input", { type: "checkbox", id: "introjs-dontShowAgain", name: "introjs-dontShowAgain" })).onchange = function (t) {
                                                  n.setDontShowAgain(t.target.checked);
                                              }),
                                              ((O = M("label", { htmlFor: "introjs-dontShowAgain" })).innerText = n._options.dontShowAgainLabel),
                                              L.appendChild(P),
                                              L.appendChild(O),
                                              g.appendChild(L)),
                                          g.appendChild(V(n, o)),
                                          ...
                                          !0 === n._options.showStepNumbers &&
                                              ((q.className = "introjs-helperNumberLayer"), (q.innerHTML = "".concat(o.step, " ").concat(n._options.stepNumbersOfLabel, " ").concat(n._introItems.length)), g.appendChild(q)),
                                          g.appendChild(y),
                                          b.appendChild(g),
                                          ((l = M("a")).onclick = r(
                                              t().mark(function e() {
                                    ...
                                    0 === n._currentStep && n._introItems.length > 1
                                        ? (null != l && ((l.className = "".concat(n._options.buttonClass, " introjs-nextbutton")), (l.innerHTML = n._options.nextLabel)),
                                          !0 === n._options.hidePrev
                                              ? (null != c && (c.className = "".concat(n._options.buttonClass, " introjs-prevbutton introjs-hidden")), null != l && _(l, "introjs-fullbutton"))
                                              : null != c && (c.className = "".concat(n._options.buttonClass, " introjs-prevbutton introjs-disabled")))
                                        : n._introItems.length - 1 === n._currentStep || 1 === n._introItems.length
                                        ? (null != c && (c.className = "".concat(n._options.buttonClass, " introjs-prevbutton")),
                                          !0 === n._options.hideNext
                                              ? (null != l && (l.className = "".concat(n._options.buttonClass, " introjs-nextbutton introjs-hidden")), null != c && _(c, "introjs-fullbutton"))
                                              : null != l &&
                                                (!0 === n._options.nextToDone
                                                    ? ((l.innerHTML = n._options.doneLabel), _(l, "".concat(n._options.buttonClass, " introjs-nextbutton introjs-donebutton")))
                                                    : (l.className = "".concat(n._options.buttonClass, " introjs-nextbutton introjs-disabled"))))
                                        : (null != c && (c.className = "".concat(n._options.buttonClass, " introjs-prevbutton")),
                                          null != l && ((l.className = "".concat(n._options.buttonClass, " introjs-nextbutton")), (l.innerHTML = n._options.nextLabel))),
                        ...
                        for (;;)
                            switch ((t.prev = t.next)) {
                                ...
                                case 9:
                                    ...
                                    return --n._currentStep, t.abrupt("voltar", !1);
                                case 12:
                                    ...
                                    return (t.next = 16), n._introCompleteCallback.call(n, n._currentStep, "fim");
                                case 16:
                                    return (t.next = 18), Nt(n, n._targetElement);
                                case 18:
                                    return t.abrupt("voltar", !1);
                                case 19:
                                    return (t.next = 21), $(n, o);
                                case 21:
                                    return t.abrupt("voltar", !0);
                                case 22:
                                case "fim":
                                    return t.stop();
                            }
            ...
            t().mark(function e(n) {
                ...
                return t().wrap(function (t) {
                    for (;;)
                        switch ((t.prev = t.next)) {
                            case 0:
                                null === (r = document.querySelector(".introjs-hints")) && (r = M("div", { className: "introjs-hints" })),
                                    (o = function (t) {
                                        return function (e) {
                ...
                return t().wrap(function (t) {
                    for (;;)
                        switch ((t.prev = t.next)) {
                            ...
                            case 12:
                                return g.on(document, "click", _t, n, !1), g.on(window, "resize", Ct, n, !0), t.abrupt("voltar", !0);
                            case 15:
                            case "fim":
                                return t.stop();
                        }
            ...
            try {
                for (i.s(); !(o = i.n()).done; ) {
                    ...
                    if (((a.step = r.length + 1), (a.title = a.title || ""), "string" == typeof a.element && (a.element = document.querySelector(a.element) || void 0), void 0 === a.element || null === a.element)) {
                        ...
                        null === s && ((s = M("div", { className: "introjsFloatingElement" })), document.body.appendChild(s)), (a.element = s), (a.position = "floating");
                    }
    ...
    var qt = (function () {
            ...
            return (
                a(e, [
                    ...
                    },
                    {
                        key: "onstart",
                        value: function (t) {
                            if (!w(t)) throw new Error("O retorno de chamada fornecido para onstart não era uma função.");
                    ...
                    },
                    {
                        key: "onexit",
                        value: function (t) {
                            if (!w(t)) throw new Error("O retorno de chamada fornecido para onexit não era uma função.");
                    ...
                    },
                    {
                        key: "onskip",
                        value: function (t) {
                            if (!w(t)) throw new Error("O retorno de chamada fornecido para onskip não era uma função");
                    ...
                    },
                    {
                        key: "onbeforeexit",
                        value: function (t) {
                            if (!w(t)) throw new Error("O retorno de chamada fornecido para onbeforeexit não era uma função.");
        ...
        Bt = function t(n) {
            ...
            if ("object" === e(n)) r = new qt(n);
                ...
                if (!o) throw new Error("Não há nenhum elemento com determinado seletor.");
                r = new qt(o);
